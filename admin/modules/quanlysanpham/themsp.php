<div class="content1" >
    ...
    <table id="bangthemhangsp">
        <form method="POST" action="modules/quanlysanpham/xulysp.php" enctype="multipart/form-data">
            <tbody>
                <tr>
                    <td>Mã sản phẩm:</td>
                ...
                <tr>
                    <td colspan="2"><input name="themsp" type="submit" value="Thêm" style="width:100%; text-align:center; margin-top:7px; font-weight: bold; font-size: 20px;"></td>
                </tr>
            </tbody>
        </form>
    </table>
